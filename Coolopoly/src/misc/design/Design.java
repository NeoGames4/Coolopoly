...
public class Design {
	...
	public static final Color	INFO_PANEL_BACKGROUND_COLOR			= new Color( 50,  50,  75),
								...
								INFO_PANEL_YELLOW_COLOR				= new Color(250, 240,  20),
	...
	public static final Color	SETTINGS_BACKGROUND_COLOR	= new Color(  0,   0,   0, 170),
								SETTINGS_PANEL_COLOR		= new Color( 20,  20, 175),
								SETTINGS_PANEL_BORDER_COLOR	= new Color( 50,  50, 255),
								SETTINGS_FOREGROUND_COLOR	= Color.WHITE;

	public static final Stroke	SETTINGS_BORDER_STROKE		= new BasicStroke(5);
	
	public static final int		SETTINGS_BORDER_RADIUS		= 15;
	
	public static final Font	SETTINGS_TITLE_FONT			= new Font("Monospaced", Font.BOLD, 20),
								SETTINGS_TEXT_FONT			= new Font("Monospaced", Font.BOLD, 16);
	
	public static final int		SETTINGS_WINDOW_CONTENT_PADDING	= 10;
	
	
	// OVERLAY WINDOW
	
	public static final long	OVERLAY_WINDOW_DEFAULT_FADE_DURATION = 300;
