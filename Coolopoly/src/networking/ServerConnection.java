...
public class ServerConnection extends Thread {
	...
	public ServerConnection(String username, String address, int port, boolean justWatching) throws UnknownHostException, ConnectException, IOException {
		connect(username, address, port, justWatching);
	}
	
	public ServerConnection connect(String username, String address, int port, boolean justWatching) throws UnknownHostException, ConnectException, IOException {
		if(!isConnected()) {
